...
class pc_TB3 extends Phaser.Scene{
    constructor(){
        super("pc_TB3");
    }
    init(data){
    ...
    preload ()
    {
        ...
        this.load.tilemapTiledJSON('map9','assets/placeholder/pc_TB3.json');
    ...
    create ()
    {
        ...
        if (position == "TB2-TB3"){
            player = this.physics.add.sprite(1800, 400, 'dude');
        }
        else if (position == "TB1-TB3"){
            player = this.physics.add.sprite(700, 1800, 'dude');
        }
        ...
        */
        ...
        tonneau = tonneaux.create(950, 750, 'tonneau');
        tonneau = tonneaux.create(1250, 1150, 'tonneau');
        ...
        barricade = barricades.create(700, 1700, 'barricade');
        barricade = barricades.create(900, 1700, 'barricade');
        ...
        tonneauPotion = tonneauxPotion.create(650, 850, 'tonneau');

        tonneauPotion = tonneauxPotion.create(1850, 1850, 'tonneau');
        ...
        if (barrilCollected == false){
            ...
            this.physics.add.overlap(player,collectBarril, collectBarrild);
    
            function collectBarrild(player, collectBarril){
                barrilCollected = true;
                collectBarril.destroy();
        }
        }
