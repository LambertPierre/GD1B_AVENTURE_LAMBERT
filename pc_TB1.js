...
var ennemi4;
var vieEnnemi4 = 10;
var ennemi4Mort = false;
var ennemi4Invinsible = false;
var ennemi4Stop = false;
var ennemi4Aggro = false;


class pc_TB1 extends Phaser.Scene{
    constructor(){
        super("pc_TB1");
    }
    init(data){
    ...
    preload ()
    {
        ...
        this.load.tilemapTiledJSON('map7','assets/placeholder/pc_TB1.json');
    ...
    create ()
    {
        ...
        if (position == "TB2-TB1"){
            player = this.physics.add.sprite(1800, 300, 'dude');
        }
        ...
        if (vieEnnemi4 > 0 ){
            ennemi4 = ennemis.create(499, 1600, 'ennemi');
            ennemi4.body.height = 100;
            ennemi4.body.setOffset(0, 50);  
        }
       

        this.physics.add.collider(orange, ennemi4);
        this.physics.add.collider(bleu, ennemi4);

        this.physics.add.overlap(ennemi4, epees, epeeEnnemi);
        this.physics.add.overlap(ennemi4, boulets, bouletEnnemi);
        this.physics.add.overlap(ennemi4, explosions, explosionEnnemi);
        this.physics.add.overlap(ennemi4, megaExplosions, megaExplosionEnnemi);

        this.physics.add.overlap(player, ennemis, hitEnnemi);

        function epeeEnnemi(ennemi4, epees){
            if (ennemi4Invinsible == false){
                vieEnnemi4 -= 3;
                if(vieEnnemi4 <= 0){
                    potion = potions.create(ennemi4.x, ennemi4.y, 'potion');
                    ennemi4.destroy();
                    ennemi4Mort = true;
                }
                else{
                    ennemi4Invinsible=true;
                    ennemi4Stop = true;
                    ennemi4.setVelocityX(0);
                    ennemi4.setVelocityY(0);
                    ennemi4.alpha = 0.5;
                    setTimeout(function(){ennemi4Invinsible = false}, 1000);
                    setTimeout(function(){ennemi4.alpha = 1}, 1000);
                    setTimeout(function(){ennemi4Stop=false}, 1000);  
                }
            }
        ...
        function explosionEnnemi(ennemi4, explosions){
            if (ennemi4Invinsible == false){
                vieEnnemi4 -= 2;
                if(vieEnnemi4 <= 0){
                    potion = potions.create(ennemi4.x, ennemi4.y, 'potion');
        ...
        function megaExplosionEnnemi(ennemi4, megaExplosions){
            if (ennemi4Invinsible == false){
                vieEnnemi4 -= 4;
                if(vieEnnemi4 <= 0){
                    potion = potions.create(ennemi4.x, ennemi4.y, 'potion');
        ...
        function hitEnnemi(player, ennemi4){
            if (invinsible == false){
                vie -= 1;
                invinsible = true;
                player.alpha = 0.5;
        ...
        tonneau = tonneaux.create(1850, 1150, 'tonneau');
        ...
        caisse = caisses.create(150, 1150, 'caisse');
        caisse = caisses.create(250, 1150, 'caisse');
        caisse = caisses.create(350, 1150, 'caisse');
        caisse = caisses.create(450, 1150, 'caisse');
        caisse = caisses.create(550, 1150, 'caisse');
        caisse = caisses.create(650, 1150, 'caisse');
        ...
        barricade = barricades.create(600, 300, 'barricade');

        barricade = barricades.create(1600, 1300, 'barricade');
        ...
        barril = barrils.create(600, 1500, 'barril');

        barril = barrils.create(1550, 1550, 'barril');
        ...
        tonneauPotion = tonneauxPotion.create(1250, 250, 'tonneau');
    ...
    update ()
    {
        ...
        if (ennemi4.x < 500 && ennemi4.y == 1600 && ennemi4Stop == false && ennemi4Mort == false){
            ennemi4.setVelocityX(250);
            ennemi4.setVelocityY(0);
        }
        if (ennemi4.x > 1400 && ennemi4.y == 1600 && ennemi4Stop == false && ennemi4Mort == false){
            ennemi4.setVelocityX(-250);
            ennemi4.setVelocityY(0);
        }
        if(ennemi4.y == 1600 && 500<ennemi4.x>1400 && ennemi4Stop == false && ennemi4Mort == false){
        ...
        if (Math.pow((Math.pow(player.x-ennemi4.x,2))+(Math.pow(player.y-ennemi4.y,2)),1/2)<=300){
            ennemi4Aggro = true;
        }
        if (ennemi4Aggro == true && ennemi4Stop == false && ennemi4Mort == false){
            ennemi4.setVelocityX(player.x-ennemi4.x);
            ennemi4.setVelocityY(player.y-ennemi4.y);
            ennemi4.setMaxVelocity(250);
        }
